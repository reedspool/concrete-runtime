...
var tests = {
  ...
  // Value Reference 
  '1 2 + 0#A *A 2 > _ END': '1 2 + 3#A *A 2 > "Greater Than" END',

  // Value References don't get overridden by internal handles
  '1 2 + 0#A [ 1#A ] *A 2 > _ END': '1 2 + 3#A [ 1#A ] *A 2 > "Greater Than" END',
